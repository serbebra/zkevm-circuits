...
/// Mock 1 ETH
pub static MOCK_1_ETH: Lazy<Word> = Lazy::new(|| eth(1));
/// Mock coinbase value
pub static MOCK_COINBASE: Lazy<Address> =
    Lazy::new(|| address!("0x00000000000000000000000000000000c014ba5e"));
/// Mock gasprice value
pub static MOCK_GASPRICE: Lazy<Word> = Lazy::new(|| Word::from(1u8));
/// Mock BASEFEE value
pub static MOCK_BASEFEE: Lazy<Word> = Lazy::new(Word::zero);
/// Mock GASLIMIT value
pub static MOCK_GASLIMIT: Lazy<Word> = Lazy::new(|| Word::from(0x2386f26fc10000u64));
/// Mock chain ID value
pub const MOCK_CHAIN_ID: u64 = 1338;
/// Mock DIFFICULTY value
pub static MOCK_DIFFICULTY: Lazy<Word> = Lazy::new(|| Word::from(0x200000u64));
/// Mock DIFFICULTY value for l2geth (always 0)
pub static MOCK_DIFFICULTY_L2GETH: Lazy<Word> = Lazy::new(|| Word::from(0x0u64));
/// Mock accounts loaded with ETH to use for test cases.
pub static MOCK_ACCOUNTS: Lazy<Vec<Address>> = Lazy::new(|| {
    vec![
...
pub static MOCK_CODES: Lazy<Vec<Bytes>> = Lazy::new(|| {
    vec![
...
pub static MOCK_WALLETS: Lazy<Vec<LocalWallet>> = Lazy::new(|| {
...
pub static MOCK_DEPLOYED_CONTRACT_BYTECODE: Lazy<Word> =
    Lazy::new(|| word!("6B6020600060003760206000F3600052600C6014F3"));

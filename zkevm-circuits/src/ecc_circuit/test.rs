...
mod valid_invalid_cases {
    ...
    pub(crate) static EC_ADD_OPS: Lazy<Vec<EcAddOp>> = Lazy::new(|| {
        vec![
    ...
    pub(crate) static EC_MUL_OPS: Lazy<Vec<EcMulOp>> = Lazy::new(|| {
        vec![
    ...
    pub(crate) static EC_PAIRING_OPS1: Lazy<Vec<EcPairingOp>> = Lazy::new(|| {
        vec![
    ...
    pub(crate) static EC_PAIRING_OPS2: Lazy<Vec<EcPairingOp>> = Lazy::new(|| {
        vec![
    ...
    pub(crate) static EC_PAIRING_OPS3: Lazy<Vec<EcPairingOp>> = Lazy::new(|| {
        vec![
    ...
    pub(crate) static EC_PAIRING_OPS4: Lazy<Vec<EcPairingOp>> = Lazy::new(|| {
        vec![

use crate::{AggregationConfig, RlcConfig};
...
//             PlonkSuccinctVerifier::verify(&svk, &snark.protocol, &snark.instances,
// &proof).unwrap()         })
//         .collect::<Vec<_>>();
...
//     let accumulator =
//         // core step
//         // KzgAs does KZG accumulation scheme based on given accumulators and random number (for
// adding blinding)         // accumulated ec_pt = ec_pt_1 * 1 + ec_pt_2 * r + ... + ec_pt_n *
// r^{n-1}         // ec_pt can be lhs and rhs

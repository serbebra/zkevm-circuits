...
RUN mkdir configs
RUN curl -o ./configs/layer1.config https://circuit-release.s3.us-west-2.amazonaws.com/release-v0.9.0/layer1.config
RUN curl -o ./configs/layer2.config https://circuit-release.s3.us-west-2.amazonaws.com/release-v0.9.0/layer2.config
